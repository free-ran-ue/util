...
var testSupiCases = []struct {
...
}{
	{
		...
		expectedLength: 11,
		expectedBytes:  []byte{0x01, 0x02, 0xf8, 0x39, 0xf0, 0xff, 0x00, 0x00, 0x00, 0x47, 0x78},
	},
	{
		...
		expectedLength: 11,
		expectedBytes:  []byte{0x01, 0x02, 0xf8, 0x39, 0xf0, 0xff, 0x00, 0x00, 0x00, 0x00, 0x10},
	},
	{
		...
		expectedLength: 11,
		expectedBytes:  []byte{0x01, 0x00, 0x11, 0x00, 0xf0, 0xff, 0x00, 0x00, 0x00, 0x00, 0xf1},
	},
}
